...
public class HomingArrowItem extends ArrowItem implements ProjectileItem {
    public HomingArrowItem(Properties properties)
    {
        super (properties);
    }
    ...
    public AbstractArrow createArrow(Level level, ItemStack ammo, LivingEntity shooter, @Nullable ItemStack weapon) {
        AmethystArrowEntity arrow = new AmethystArrowEntity(EntityInit.AMETHYST_ARROW.get(), level);
