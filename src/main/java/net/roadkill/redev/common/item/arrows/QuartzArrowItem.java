...
public class QuartzArrowItem extends ArrowItem implements ProjectileItem {
    public QuartzArrowItem(Properties properties)
    {
        super (properties);
    }
    ...
    public AbstractArrow createArrow(Level level, ItemStack ammo, LivingEntity shooter, @Nullable ItemStack weapon) {
        QuartzArrowEntity arrow = new QuartzArrowEntity(EntityInit.QUARTZ_ARROW.get(), level);
