...
public class GlowInkArrowRenderer extends ArrowRenderer<AmethystArrowEntity, ArrowRenderState> {
    ...
    public GlowInkArrowRenderer(EntityRendererProvider.Context context)
    {   super(context);
    }
