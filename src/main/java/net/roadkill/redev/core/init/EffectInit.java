...
import net.roadkill.redev.common.effect.BossDeMinionEffect;
...
public final class EffectInit
{
    ...
    public static final DeferredHolder<MobEffect, MobEffect> DE_ADDED = EFFECTS.register("de_added", BossDeMinionEffect::new);
}
